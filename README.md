...
ResourceWhat we extractPatientAge, DOB, state, addressConditionICD-10 diagnosis code (F84.0), onset dateCoverageInsurance type, payer name, member IDObservationAssessment scores (CARS-2, ADOS-2)PractitionerDiagnosing physician name and credentialsDiagnosticReportFull diagnostic summary text
...
bashgit clone https://github.com/YOUR_USERNAME/post-dx-agent
cd post-dx-agent
npm install

Add your Anthropic API key:

bashecho 'ANTHROPIC_API_KEY=sk-ant-your-key' > .env.local
